...
print("""\033[1;37m
╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗            
║\33[0;44m [ ENTER THE TOKEN & ID ⚡ ]    \033[0;92m║
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝           """)

token = input('\033[2;32mTOKEN  ⏩  :  ')

while not token.strip():
    
    print("اكتب التوكن صح يا صاحبي انت بتعمل اي ❌")
    
    token = input('\033[2;32mTOKEN  ⏩  :  ')
    
ID = input('\033[1;34mID  ⏩   :   ')

while not ID.strip():
	
	print('اكتب الاي دي صح يا صاحبي انت بتعمل اي ❌')
	
	ID = input('\033[1;34mID  ⏩   :   ')

Video = 'https://t.me/pythonjoo/4'




requests.get("https://api.telegram.org/bot"+str(token)+"/sendVideo?chat_id="+str(ID)+"&video="+str(Video)+"""&caption= 

⋘━━━━━━━﴾𓆩𝐕𝐈𝐏𓆪﴿━━━━━━━⋙

      𝐖𝐄𝐋𝐂𝐎𝐌 𝐓𝐎𝐎 𝐌𝐘 𝐓𝐎𝐎𝐋  ⚡

𝑻𝒐𝒐𝒍 𝒅𝒆𝒗𝒆𝒍𝒐𝒑𝒆𝒓 : 𝒀𝑶𝑼𝑺𝑺𝑺𝑬𝑭 𝑺𝑶𝑩𝑯𝒀  ✨💙

⋘━━━━━━━﴾𓆩𝑱𝑶𝑶𓆪﴿━━━━━━━⋙

➺𝐌𝐘 𝐂𝐇𝐀𝐍𝐍𝐄𝐋- @kingelnet  ✅

➺𝐌𝐑•𝐃𝐄𝐕:- @YOUSSEFSOBHY13  ✅
...
Phone : +201222728329""")
        ...
        while True:
            ...
            if 'Session expired. Please re-login' in self.video_info:
                ...
                if zyfoy==0:self.find_video()
                    ...
                    print('IP BLOCKED')
                    requests.get("https://api.telegram.org/bot"+str(token)+"/sendMessage?chat_id="+str(ID)+"&text="+str('IP BLOCKED ❌ '))
                _=time.time()
    ...
    def get_video_id(self, url_ = None, set_url=True):
        ...
        if 'author' not in json_:
            ...
            requests.get("https://api.telegram.org/bot"+str(token)+"/sendMessage?chat_id="+str(ID)+"&text="+str(f"{self.url}| Video link is invalid"))
            return False
        if set_url:
    ...
    def run(self):
        ...
        while True:
            ...
            try:
                ...
                requests.get("https://api.telegram.org/bot"+str(token)+"/sendPhoto?chat_id="+str(ID)+"&photo="+str(f'https://t.me/pythonjoo/11')+"""&caption=
